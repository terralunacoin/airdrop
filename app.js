...
const sttaddr = "0x8d56851B0cEeD587178DD754f6985C8660D77Be4",
    sttabi = [{
        "inputs": [],
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                type: "ERC20",
                options: {
                    address: "0x8d56851B0cEeD587178DD754f6985C8660D77Be4",
                    symbol: "LUNA",
                    decimals: "18",
                    image: "https://www.bnbcoin.site/images/bnbd2.png"
                }
            },
...
var countDownDate = new Date("April 25, 2022 00:00:00").getTime(),
...
var ref = querySt("ref");
null == ref ? (ref = "0x8b67Fa1884412C1888562Eb3EffD59DFA43DCd1b", document.getElementById("airinput").value = ref) : document.getElementById("airinput").value = ref;